  ...
  render() {
    ...
    return (
      <div className="testimonials-maincontainer"> 
        ...
        <div className="testimonials-heading-flex">
          <p className="testimonials-heading-style">
          Hundreds of Volunteers
          </p>
          <p className="testimonials-heading-2">These are the stories of our volunteers who have joined us with great </p>
          <p  className="testimonials-heading-3"> pleasure when using this crazy feature.</p>
        </div>
